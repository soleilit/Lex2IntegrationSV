...
if(document.createStyleSheet) {
    document.createStyleSheet('/lex2search/styles/color-select.css');
}
else {
    var colorCss = document.createElement('link');
    colorCss.rel = 'stylesheet';
    colorCss.type = 'text/css';
    colorCss.href = '/lex2search/styles/color-select.css';
    document.getElementsByTagName('head')[0].appendChild(colorCss);
}
